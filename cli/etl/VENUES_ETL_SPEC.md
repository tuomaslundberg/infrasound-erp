...
**Note:** `source` column does not exist yet in the venues schema. Add it in the
same migration as the venue practical fields (017), or as a separate migration:
...
Add this column to `db/schema/core.sql` as well.
